 ...
 */
defined('PHPFOX_LIBRARY_DIR') OR define('PHPFOX_LIBRARY_DIR', PHPFOX_DIR . 'library' . DS);

/**
 * @const PHPFOX_PACKAGE_DIR string
 */
defined('PHPFOX_PACKAGE_DIR') OR define('PHPFOX_PACKAGE_DIR', PHPFOX_DIR . 'package' . DS);
 ...
 */
defined('PHPFOX_DATA_DIR') OR define('PHPFOX_DATA_DIR', PHPFOX_DIR . 'data' . DS);
 ...
 */
defined('PHPFOX_SESSION_DIR') OR define('PHPFOX_SESSION_DIR', PHPFOX_DATA_DIR . 'session' . DS);

/**
 * @const PHPFOX_LOG_DIR string
 */
defined('PHPFOX_LOG_DIR') OR define('PHPFOX_LOG_DIR', PHPFOX_DATA_DIR . 'log' . DS);

/**
 * @const PHPFOX_TEMP_DIR string
 */
defined('PHPFOX_TEMP_DIR') OR define('PHPFOX_TEMP_DIR', PHPFOX_DATA_DIR . 'temp' . DS);
