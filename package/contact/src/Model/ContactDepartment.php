...
{
    public function getModelId(){return 'contact_department';}

    public function getDepartmentId(){return (int) $this->__get('department_id');}
    public function getId(){return (int) $this->__get('department_id');}
    public function setDepartmentId($value){$this->__set('department_id', $value);}
    public function setId($value){$this->__set('department_id', $value);}
    
    public function getName(){return $this->__get('name');}
    public function setName($value){$this->__set('name', $value);}
    
    public function getEmail(){return $this->__get('email');}
    public function setEmail($value){$this->__set('email', $value);}
