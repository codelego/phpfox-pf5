...
class StorageAdapterTest extends \PHPUnit_Framework_TestCase
{
    public function testBase()
    {
        $obj = new StorageAdapter([
            'adapter_id'   => 1,
            'adapter_name' => 'Local File System',
            'driver_id'    => 'local',
            'params'       => '{"basePath":"public","baseUrl":"http:\\/\\/namnv.local\\/pf5\\/","baseCdnUrl":"http:\\/\\/aws.max-cdn.com\\/adbc\\/","is_active":"1"}',
            'is_active'    => 1,
            'is_required'  => 1,
        ...
        $this->assertSame('{"basePath":"public","baseUrl":"http:\/\/namnv.local\/pf5\/","baseCdnUrl":"http:\/\/aws.max-cdn.com\/adbc\/","is_active":"1"}',
            $obj->getParams());
