...
class SiteSettingFormTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $obj = new SiteSettingForm(array (  'form_id' => 'blog',  'package_id' => 'blog',  'title' => 'Blog Settings',  'form_name' => 'Neutron\\Blog\\Form\\Admin\\Settings\\SiteSettings',  'description' => 'Blog Settings',  'ordering' => 2,  'is_active' => 1,));
