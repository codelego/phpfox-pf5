...
class I18nMessage extends DbModel
{
    ...
    public function getMessageName(){return $this->__get('message_name');}
    public function setMessageName($value){$this->__set('message_name', $value);}
    
    public function getMessageValue(){return $this->__get('message_value');}
    public function setMessageValue($value){$this->__set('message_value', $value);}
    
    public function isJson(){return $this->__get('is_json') ?1:0;}
    public function setJson($value){$this->__set('is_json',$value?1:0);}
