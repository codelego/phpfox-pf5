...
class LayoutLocation extends DbModel
{
    ...
    public function getId(){return (int) $this->__get('container_id');}
    public function setContainerId($value){$this->__set('container_id', $value);}
    public function setId($value){$this->__set('container_id', $value);}
    
    public function getLocationId(){return $this->__get('location_id');}
    public function getId(){return $this->__get('location_id');}
