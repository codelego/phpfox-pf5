...
{
    public function getModelId(){return 'core_package';}
    ...
    public function getPriority(){return (int) $this->__get('priority');}
    public function setPriority($value){$this->__set('priority', $value);}
    
    public function getTitle(){return $this->__get('title');}
    public function setTitle($value){$this->__set('title', $value);}
    
    public function getVersion(){return $this->__get('version');}
    public function setVersion($value){$this->__set('version', $value);}
    
    public function getLatestVersion(){return $this->__get('latest_version');}
    public function setLatestVersion($value){$this->__set('latest_version', $value);}
    
    public function getAuthor(){return $this->__get('author');}
    public function setAuthor($value){$this->__set('author', $value);}
    ...
    public function getAppsIcon(){return $this->__get('apps_icon');}
    public function setAppsIcon($value){$this->__set('apps_icon', $value);}
    
    public function getName(){return $this->__get('name');}
    public function setName($value){$this->__set('name', $value);}
    
    public function getPath(){return $this->__get('path');}
    public function setPath($value){$this->__set('path', $value);}
    }