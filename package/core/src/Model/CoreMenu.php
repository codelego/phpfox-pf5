...
class CoreMenu extends DbModel
{
    ...
    public function getMenu(){return $this->__get('menu');}
    public function setMenu($value){$this->__set('menu', $value);}
    ...
    public function getAcl(){return $this->__get('acl');}
    public function setAcl($value){$this->__set('acl', $value);}
    
    public function getEvent(){return $this->__get('event');}
    public function setEvent($value){$this->__set('event', $value);}
    
    public function getPlugin(){return $this->__get('plugin');}
    public function setPlugin($value){$this->__set('plugin', $value);}
    ...
    public function getType(){return $this->__get('type');}
    public function setType($value){$this->__set('type', $value);}
    }