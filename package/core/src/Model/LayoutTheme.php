...
class LayoutTheme extends DbModel
{
    ...
    public function getParentId(){return $this->__get('parent_id');}
    ...
    public function isEditing(){return $this->__get('is_editing') ?1:0;}
    public function setEditing($value){$this->__set('is_editing',$value?1:0);}
