...
class CoreRealmDriver extends DbModel
{
    public function getModelId(){return 'core_realm_driver';}

    public function getId(){return $this->__get('id');}
    public function setId($value){$this->__set('id', $value);}
    
    public function getDriver(){return $this->__get('driver');}
    public function setDriver($value){$this->__set('driver', $value);}
    
    public function getJsonConfigs(){return $this->__get('json_configs');}
    public function setJsonConfigs($value){$this->__set('json_configs', $value);}
