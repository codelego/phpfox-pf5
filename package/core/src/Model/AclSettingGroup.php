...
class AclSettingGroup extends DbModel
{
    public function getModelId(){return 'acl_setting_group';}

    public function getGroupId(){return $this->__get('group_id');}
    public function getId(){return $this->__get('group_id');}
    public function setGroupId($value){$this->__set('group_id', $value);}
    public function setId($value){$this->__set('group_id', $value);}
