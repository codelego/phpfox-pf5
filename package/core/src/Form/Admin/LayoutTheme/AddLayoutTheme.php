...
class AddLayoutTheme extends Form {

    public function initialize(){

        $this->setTitle(_text('Add Layout Theme',''));
        $this->setInfo(_text('[Add Layout Theme Info]',''));
        $this->setAction(_url('#'));
...
/** element `is_editing` **/
$this->addElement(array ( 'name' => 'is_editing', 'factory' => 'yesno', 'label' => _text('Is Editing',null), 'note' => _text('[Is Editing Note]', null), 'value' => '0', 'required' => true, ));        
