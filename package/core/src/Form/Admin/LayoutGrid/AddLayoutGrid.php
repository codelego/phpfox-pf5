...
/** element `grid_id` **/
$this->addElement(array ( 'name' => 'grid_id', 'factory' => 'text', 'label' => _text('Grid Id',null), 'note' => _text('[Grid Id Note]', null), 'maxlength' => 255, 'required' => true, ));        
...
/** element `locations` **/
$this->addElement(array ( 'name' => 'locations', 'factory' => 'textarea', 'label' => _text('Locations',null), 'note' => _text('[Locations Note]', null), 'maxlength' => 255, 'required' => false, ));        
        /** end elements **/
