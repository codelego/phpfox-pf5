...
class AddCoreMenuItem extends Form {
    ...
    public function initialize(){
        ...
        /** start elements **/
            ...
            $this->addElement(array ( 'name' => 'href', 'factory' => 'text', 'label' => _text('Href','_core.menu'), 'placeholder' => _text('Href','_core.menu'), 'required' => true, ));        
            ...
            $this->addElement(array ( 'name' => 'package_id', 'factory' => 'hidden', ));        
        /** end elements **/
