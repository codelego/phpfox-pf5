...
class EditGeneralSettings extends Form {
    ...
    public function initialize(){
        ...
        /** start elements **/
            ...
            /** element `core__offline_mode` **/
            $this->addElement(array ( 'name' => 'core__offline_mode', 'factory' => 'radio', 'label' => _text('Offline Mode','_core.general_settings'), 'info' => _text('[Offline Mode Info]', '_core.general_settings'), 'options' => _get('core.setting')->getSiteModeIdOptions(), 'required' => true, ));        
        
            /** element `core__offline_code` **/
            $this->addElement(array ( 'name' => 'core__offline_code', 'factory' => 'text', 'label' => _text('Offline Code','_core.general_settings'), 'info' => _text('[Offline Code Info]', '_core.general_settings'), 'required' => true, ));        
        
            /** element `core__private_mode` **/
            $this->addElement(array ( 'name' => 'core__private_mode', 'factory' => 'radio', 'label' => _text('Private Site','_core.general_settings'), 'info' => _text('[Private Site Info]', '_core.general_settings'), 'options' => _get('core.setting')->getPrivateSiteIdOptions(), 'required' => true, ));        
