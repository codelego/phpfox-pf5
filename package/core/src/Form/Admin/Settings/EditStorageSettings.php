...
class EditStorageSettings extends Form {
    ...
    public function initialize(){
        ...
        /** start elements **/
            ...
            $this->addElement(array ( 'name' => 'core__default_storage_id', 'factory' => 'select', 'label' => _text('Default Storage','_core.storage'), 'info' => _text('[Default Storage Id Info]', '_core.storage'), 'options' => _get('core.storage')->getAdapterIdOptions(), 'required' => true, ));        
        /** end elements **/
