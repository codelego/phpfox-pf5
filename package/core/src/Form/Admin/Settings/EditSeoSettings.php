...
class EditSeoSettings extends Form {
    ...
    public function initialize(){
        ...
        /** start elements **/
            ...
            $this->addElement(array ( 'name' => 'core__title_separator', 'factory' => 'text', 'label' => _text('Title Separator','_core.seo_settings'), 'info' => _text('[Title Separator Info]', '_core.seo_settings'), 'required' => true, ));        
        
            /** element `core__site_description` **/
            $this->addElement(array ( 'name' => 'core__site_description', 'factory' => 'text', 'label' => _text('Site Description','_core.seo_settings'), 'info' => _text('[Site Description Info]', '_core.seo_settings'), 'required' => true, ));        
            ...
            $this->addElement(array ( 'name' => 'core__site_keyword', 'factory' => 'text', 'label' => _text('Site Keyword','_core.seo_settings'), 'info' => _text('[Site Keyword Info]', '_core.seo_settings'), 'required' => true, ));        
            ...
            $this->addElement(array ( 'name' => 'core__facebook_app_id', 'factory' => 'select', 'label' => _text('Facebook App','_core.seo_settings'), 'info' => _text('[Facebook App Id Info]', '_core.seo_settings'), ));        
            ...
            $this->addElement(array ( 'name' => 'core__google_analytic_id', 'factory' => 'select', 'label' => _text('Google Analytic','_core.seo_settings'), 'info' => _text('[Google Analytic Id Info]', '_core.seo_settings'), ));        
        
            /** element `core__google_plus_id` **/
            $this->addElement(array ( 'name' => 'core__google_plus_id', 'factory' => 'select', 'label' => _text('Google Plus','_core.seo_settings'), 'info' => _text('[Google Plus Id Info]', '_core.seo_settings'), ));        
