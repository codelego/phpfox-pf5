...
class EventCatalog extends DbModel
{
    public function getModelId(){return 'event_catalog';}

    public function getCatalogId(){return $this->__get('catalog_id');}
    public function getId(){return $this->__get('catalog_id');}
