...
<table cellpadding="0" cellspacing="0">
	<tr>
		...
		<th>{_p var='user_group'}</th>
		<th>{_p var='upgraded_user_group'}</th>
		<th class="t_center">{_p var='total_activity'}</th>
		<th class="t_center">{_p var='total_days_registered'}</th>
		<th>Created On</th>
	</tr>
	...
	<tr{if is_int($phpfox.iteration.promotions/2)} class="tr"{/if}>
		<td class="t_center">
			...
			<div class="link_menu">
				<ul>
					<li><a href="{url link='admincp.user.promotion.add' id=$aPromotion.promotion_id}">{_p var='edit'}</a></li>
