	...
	<div id="js_register_step1">
		...
		<div class="table form-group">
			<div class="table_left">
				<label for="first_name">{required}{_p var='first_name'}:</label>
			</div>
			<div class="table_right form-group">
				<input class="form-control" placeholder="{required}{_p var='first_name'}" type="text" name="val[first_name]" id="first_name" value="{value type='input' id='first_name'}" size="30" />
			</div>			
		</div>		
		<div class="table form-group">
			<div class="table_left">
				<label for="last_name">{required}{_p var='last_name'}:</label>
			</div>
		...
		<div class="table form-group">
			<div class="table_right">
				<input class="form-control" placeholder="{_p var='full_name'}" type="text" name="val[full_name]" id="full_name" value="{value type='input' id='full_name'}" size="30" />
			</div>			
		</div>
		{/if}
		{/if}
