...
class User_Component_Controller_Admincp_Cancellations_Feedback extends Phpfox_Component
{
	...
	{		
		...
		$aFeedbacks = User_Service_Cancellations_Cancellations::instance()->getFeedback();
		
		$this->template()->setTitle(_p('view_feedback_on_cancellations'))
			->setBreadCrumb(_p('view_feedback_on_cancellations'), $this->url()->makeUrl('admincp.user.cancellations.feedback'))
			->assign(array(
