...
class DevElement extends DbModel
{
    ...
    {
        return (int)$this->__get('element_id');
    }
    ...
    {
        return $this->__get('element_name');
    }

    public function setElementName($value)
    {
        $this->__set('element_name', $value);
    }
    ...
    {
        return $this->__get('info_domain');
    }

    public function setInfoDomain($value)
    {
        $this->__set('info_domain', $value);
    }
    ...
    {
        return $this->__get('max_length');
    }

    public function setMaxLength($value)
    {
        $this->__set('max_length', $value);
    }
    ...
    {
        return $this->__get('is_readonly') ? 1 : 0;
    }

    public function setReadonly($value)
    {
        $this->__set('is_readonly', $value ? 1 : 0);
    }

    public function isDisabled()
    {
        return $this->__get('is_disabled') ? 1 : 0;
    }

    public function setDisabled($value)
    {
        $this->__set('is_disabled', $value ? 1 : 0);
    }
    ...
    {
        return $this->__get('is_primary') ? 1 : 0;
    }

    public function setPrimary($value)
    {
        $this->__set('is_primary', $value ? 1 : 0);
    }

    public function isIdentity()
    {
        return $this->__get('is_identity') ? 1 : 0;
    }

    public function setIdentity($value)
    {
        $this->__set('is_identity', $value ? 1 : 0);
    }

    public function getDataCmd()
    {
        return $this->__get('data_cmd');
    }

    public function setDataCmd($value)
    {
        $this->__set('data_cmd', $value);
    }
    ...
    public function getPrimaryLength()
    {
        return (int)$this->__get('primary_length');
    }

    public function setPrimaryLength($value)
    {
        $this->__set('primary_length', $value);
    }

    public function getOptionsText()
    {
        return $this->__get('options_text');
    }

    public function setOptionsText($value)
    {
        $this->__set('options_text', $value);
    }

    public function getNoteDomain()
    {
        return $this->__get('note_domain');
    }

    public function setNoteDomain($value)
    {
        $this->__set('note_domain', $value);
    }

    public function getHasNote()
    {
        return (int)$this->__get('has_note');
    }

    public function setHasNote($value)
    {
        $this->__set('has_note', $value);
    }

    public function getHasInfo()
    {
        return (int)$this->__get('has_info');
    }

    public function setHasInfo($value)
    {
        $this->__set('has_info', $value);
    }
}