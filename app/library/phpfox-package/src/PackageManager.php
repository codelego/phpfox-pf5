...
class PackageManager
{
    ...
    public function archive($dir)
    {
        ...
        $info = load_config($dir . 'config/export/info.php');

        $includePaths = $info['paths'];
        $exportFilename = $info['name'];

        $destinationZipFilename = PHPFOX_VAR_DIR . 'data/package/'
            . $exportFilename . '.zip';
        ...
        foreach ($includePaths as $includePath) {
            ...
            $includePath = realpath(PHPFOX_APP_DIR . $includePath);
    ...
    {
        return substr($pathname, strlen(PHPFOX_APP_DIR));
    }
