...
class EditDevTable extends Form
{
    ...
    public function initialize()
    {
        ...
        /** element `table_name` **/
        $this->addElement(['name' => 'table_name', 'factory' => 'text', 'label' => _text('Table Name', null), 'info' => _text('[Table Name Info]', null), 'required' => '1',]);
        ...
        /** element `action_id` **/
        $this->addElement(['name' => 'action_id', 'factory' => 'text', 'label' => _text('Action Id', null), 'info' => _text('[Action Id Info]', null), 'value' => 'default', 'required' => '1',]);
        /** end elements **/
