...
return [
    ...
    'core.admin-component'        => AdminComponentController::class,
    'core.admin-profile'          => AdminBasicProfileController::class,
    'core.admin-theme'            => AdminThemeController::class,
    'core.admin-layout-block'     => AdminLayoutBlockController::class,
    'core.admin-layout-container' => AdminLayoutContainerController::class,
