...
class EditProfileType extends Form {
    ...
    public function initialize(){
        ...
        /** start elements **/
            ...
            $this->addElement(array ( 'name' => 'catalog_id', 'factory' => 'text', 'label' => _text('Catalog Id',null), 'placeholder' => _text('Catalog Id',null), 'info' => _text('Catalog Id [Info]', null), 'value' => '0', 'required' => true, ));        
        /** end elements **/
