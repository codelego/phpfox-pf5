...
class EditCoreMenuItem extends Form
{
    ...
    public function initialize()
    {
        ...
        $this->addElement(['name' => 'href', 'factory' => 'text', 'label' => _text('Href', '_core.menu'), 'placeholder' => _text('Href', '_core.menu'), 'info' => _text('Href [Info]', '_core.menu'),]);
        ...
        $this->addElement(['name'        => 'is_active',
                           'factory'     => 'yesno',
                           'label'       => _text('Is Active', '_core.menu'),
                           'placeholder' => _text('Is Active', '_core.menu'),
                           'info'        => _text('Is Active [Info]', '_core.menu'),
                           'value'       => '1',
                           'required'    => true,
        ]);
