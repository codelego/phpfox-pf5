...
class EditGeneralSettings extends Form
{
    ...
    public function initialize()
    {
        ...
        $this->addElement(['name'     => 'core__private_mode',
                           'factory'  => 'radio',
        ...
        $this->addElement(['name'     => 'core__ajax_mode',
                           'factory'  => 'radio',
        ...
        $this->addElement(['name'     => 'core__force_https',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'     => 'core__secure_img',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'     => 'core__bundle_js',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'     => 'core__bundle_css',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'    => 'core__google_api_key',
                           'factory' => 'text',
