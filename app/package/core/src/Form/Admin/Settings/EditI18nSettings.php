...
class EditI18nSettings extends Form
{
    ...
    public function initialize()
    {
        ...
        $this->setInfo(_text('Edit Site Settings [Info]', '_core.i18n_settings'));
        $this->setMethod('post');
        $this->setAction(_url('#'));
        ...
        $this->addElement([
            'name'     => 'core__auto_locale_id',
            'factory'  => 'yesno',
            'label'    => _text('Auto Locale', '_core.i18n_settings'),
            'info'     => _text('Auto Locale Id [Info]', '_core.i18n_settings'),
            'required' => true,
        ]);
        ...
        $this->addElement([
            ...
            'options'  => \Phpfox::get('core.i18n')->getTimezoneIdOptions(),
            'required' => true,
        ]);
        ...
        $this->addElement([
            ...
            'options'  => \Phpfox::get('core.i18n')->getCurrencyIdOptions(),
            'required' => true,
        ]);
        /** end elements **/
