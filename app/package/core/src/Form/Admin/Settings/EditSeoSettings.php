...
class EditSeoSettings extends Form
{
    ...
    public function initialize()
    {
        ...
        $this->addElement(['name'     => 'core__site_title',
                           'factory'  => 'text',
        ...
        $this->addElement(['name'     => 'core__title_separator',
                           'factory'  => 'text',
        ...
        $this->addElement(['name'    => 'core__site_description',
                           'factory' => 'textarea',
        ...
        $this->addElement(['name'     => 'core__description_limit',
                           'factory'  => 'text',
        ...
        $this->addElement(['name'    => 'core__site_keyword',
                           'factory' => 'textarea',
        ...
        $this->addElement(['name'     => 'core__keyword_limit',
                           'factory'  => 'text',
        ...
        $this->addElement(['name'     => 'core__enable_facebook',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'    => 'core__facebook_app_id',
                           'factory' => 'text',
        ...
        $this->addElement(['name'    => 'core__facebook_app_secret',
                           'factory' => 'text',
        ...
        $this->addElement(['name'    => 'core__facebook_app_name',
                           'factory' => 'text',
        ...
        $this->addElement(['name'     => 'core__enable_google_plus',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'    => 'core__google_plus_id',
                           'factory' => 'select',
        ...
        $this->addElement(['name'     => 'core__enable_google_analytic',
                           'factory'  => 'yesno',
        ...
        $this->addElement(['name'    => 'core__google_analytic_id',
                           'factory' => 'text',
        ...
        $this->addElement(['name'     => 'core__enable_open_graph',
                           'factory'  => 'yesno',
