...
class ProfileQuestion extends DbModel
{
    ...
    {
        return $this->__get('attribute_id');
    }
    ...
    {
        return $this->__get('question_label');
    }

    public function setQuestionLabel($value)
    {
        $this->__set('question_label', $value);
    }
