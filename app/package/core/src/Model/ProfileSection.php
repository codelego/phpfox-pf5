...
class ProfileSection extends DbModel
{
    ...
    {
        return (int)$this->__get('section_id');
    }
    ...
    {
        return (int)$this->__get('process_id');
    }
    ...
    {
        return $this->__get('section_label');
    }

    public function setSectionLabel($value)
    {
        $this->__set('section_label', $value);
    }
