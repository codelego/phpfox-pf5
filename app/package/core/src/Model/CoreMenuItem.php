...
class CoreMenuItem extends DbModel
{
    ...
    {
        return $this->__get('menu_id');
    }

    public function setMenuId($value)
    {
        $this->__set('menu_id', $value);
    }
    ...
    {
        return $this->__get('permission');
    }

    public function setPermission($value)
    {
        $this->__set('permission', $value);
    }
    ...
    {
        return $this->__get('is_ajax') ? 1 : 0;
    }

    public function setAjax($value)
    {
        $this->__set('is_ajax', $value ? 1 : 0);
    }

    public function isSelf()
    {
        return $this->__get('is_self') ? 1 : 0;
    }

    public function setSelf($value)
    {
        $this->__set('is_self', $value ? 1 : 0);
    }
}