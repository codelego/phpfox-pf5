...
class ProfileStep extends DbModel
{
    ...
    {
        return $this->__get('step_name');
    }

    public function setStepName($value)
    {
        $this->__set('step_name', $value);
    }

    public function getFormStepName()
    {
        return $this->__get('form_step_name');
    }

    public function setFormStepName($value)
    {
        $this->__set('form_step_name', $value);
    }
