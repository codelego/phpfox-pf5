...
class I18nTimezone extends DbModel
{
    ...
    public function setTimezoneLocation($value){$this->__set('timezone_location', $value);}
    ...
    public function getTimezoneCode(){return $this->__get('timezone_code');}
    public function setTimezoneCode($value){$this->__set('timezone_code', $value);}
