...
class EditMarketplaceCategory extends Form {

    /** id=191 */
    public function initialize(){

        $this->setTitle(_text('Edit Marketplace Category',''));
        $this->setInfo(_text('Edit Marketplace Category [Form Info]',''));
        $this->setAction(_url('#'));
