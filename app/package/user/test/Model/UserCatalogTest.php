...
class UserCatalogTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $obj = new UserCatalog(['catalog_id' => 1, 'name' => 'default', 'title' => 'Standard', 'description' => 'Standard user', 'is_active' => 1, 'is_core' => 1, 'ordering' => 2,]);
