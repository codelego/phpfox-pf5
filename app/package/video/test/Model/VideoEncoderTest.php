...
class VideoEncoderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $obj = new VideoEncoder(['encoder_id'          => 'ffmpeg',
                                 'form_settings_class' => 'Neutron\\Core\\Admin\\EditMpegSettings',
                                 'is_active'           => 1,
                                 'ordering'            => 1,
                                 'package_id'          => 'video',
                                 'title'               => 'FFMPEG',
                                 'description'         => 'Encode video using ffmpeg',
                                 'dependency'          => '[]',
        ]);
    ...
    public function testSave()
    {
        ...
        $obj = \Phpfox::model('video_encoder')
