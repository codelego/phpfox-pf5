...
{
    public function getModelId(){return 'video_provider';}

    public function getProviderId(){return $this->__get('provider_id');}
    public function getId(){return $this->__get('provider_id');}
    public function setProviderId($value){$this->__set('provider_id', $value);}
    public function setId($value){$this->__set('provider_id', $value);}
