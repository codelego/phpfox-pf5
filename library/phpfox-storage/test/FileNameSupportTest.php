...
class FileNameSupportTest extends \PHPUnit_Framework_TestCase
{
    public function testMethods()
    {
        ...
        $this->assertEquals('test.txt', $fileName->getBaseName('/abc\ext/test.txt'));
        $this->assertEquals('test.txt', $fileName->getBaseName('/any/path\ext\test.txt'));
        $this->assertEquals('abc-test.txt', $fileName->getBaseName('abc-test.txt'));
        $this->assertEquals('abc-test', $fileName->getBaseName('abc-test/abc-test/abc-test'));
