...
namespace PHPSTORM_META {
    ...
    override(\Phpfox::findById(0), map([
        ...
        'contact_department' => \Neutron\ContactUs\Model\Department::class,
        ...
        'report'             => \Neutron\AbuseReport\Model\Report::class,
        'report_category'    => \Neutron\AbuseReport\Model\Category::class,
