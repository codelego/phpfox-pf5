define(['jquery'], function () {
    ...
    var pluginName = 'rangeslider',
        ...
        tpl = '<div class="rangeslider-container horizontal">' +
            '<div class="rangeslider-control rangeslider-control-left"><i class="fa fa-minus"></i></div>' +
            '<div class="rangeslider rangeslider--horizontal" id="<%= id %>">' +
            '<div class="rangeslider__seek"></div>' +
            '<div class="rangeslider__fill"></div>' +
            '<div class="rangeslider__handle"></div>' +
            '</div><div class="rangeslider-control rangeslider-control-right"><i class="fa fa-plus"></i></div></div>',
        defaults = {
            polyfill: true,
    ...
    function Plugin(element, options) {
        ...
        this.$container = $(_.template(tpl)({
            id: this.identifier,
            orientation: this.orientation,
            rangeClass: this.options.rangeClass,
            orientationClass: this.options[this.orientation + 'Class'],
            fillClass: this.options.fillClass,
            handleClass: this.options.handleClass
        })).insertAfter(this.$element);

        this.$range  = $('.rangeslider',this.$container);
        this.$fill = $('.' + this.options.fillClass, this.$container);
        this.$handle =  $('.'+ this.options.handleClass,this.$container);
